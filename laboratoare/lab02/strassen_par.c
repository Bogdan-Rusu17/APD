...
int main(int argc, char *argv[])
{
    ...
    void *(*m_tasks[11]) (void *) = {taskM1, taskM2, taskM3, taskM4, taskM5,
                                     taskM6, taskM7, taskC11, taskC12, taskC21, taskC22};


    for (int i = 0; i < 11; i++) {
		arguments[i] = i;
		int r = pthread_create(&threads[i], NULL, m_tasks[i], &arguments[i]);
